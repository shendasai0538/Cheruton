...
var _Story_Editor_BTN : Button
var _Dialog_Editor = preload("res://addons/EXP-System-Dialog/Dialog Editor/Dialog_Editor.tscn")
var _Dialog_Editor_Instance
var _Dialog_Editor_BTN : Button


func _enter_tree():
	
	self._Story_Editor_Instance = self._Story_Editor.instantiate()
	self._Story_Editor_Instance.connect("close_pressed", Callable(self, "_on_StoryFile_Editor_close_pressed"))
	...
	self.add_tool_menu_item("EXP StoryFile Editor", Callable(self, "_on_StoryFile_Editor_opened"))

	self._Dialog_Editor_Instance = self._Dialog_Editor.instantiate()
	...
	self._Story_Editor_Instance.connect("dialog_edit_pressed",
		Callable(self, "_on_Story_Editor_dialog_edit_pressed"))
	self._Story_Editor_Instance.connect("dialog_edit_pressed",
		Callable(self._Dialog_Editor_Instance, "_on_Story_Editor_dialog_edit_pressed"))
	self._Dialog_Editor_Instance.connect("close_BTN_pressed",
		Callable(self, "_on_Dialog_Editor_close_BTN_pressed"))
	self._Dialog_Editor_Instance.connect("back_BTN_pressed",
		Callable(self, "_on_Dialog_Editor_back_BTN_pressed"))
	self._Story_Editor_Instance.connect("changed_story",
		Callable(self, "_on_Story_Editor_changed_story"))
...
func _exit_tree():
	...
	self._Story_Editor_Instance.disconnect("dialog_edit_pressed",
		Callable(self._Dialog_Editor_Instance, "_on_Story_Editor_dialog_edit_pressed"))
	self._Dialog_Editor_Instance.disconnect("close_BTN_pressed",
		Callable(self, "_on_Dialog_Editor_close_BTN_pressed"))
	self._Dialog_Editor_Instance.disconnect("back_BTN_pressed",
		Callable(self, "_on_Dialog_Editor_back_BTN_pressed"))
	self._Story_Editor_Instance.disconnect("changed_story",
		Callable(self, "_on_Story_Editor_changed_story"))
...
func _on_Story_Editor_dialog_edit_pressed(story, did):
	...
	self._Story_Editor_BTN.button_pressed = false
	self._Dialog_Editor_BTN.button_pressed = true
	self._Dialog_Editor_BTN.emit_signal("pressed")


func _on_Dialog_Editor_close_BTN_pressed():
	self._Dialog_Editor_BTN.button_pressed = false
	self._Dialog_Editor_BTN.visible = false
...
func _on_Dialog_Editor_back_BTN_pressed():
	self._Story_Editor_BTN.button_pressed = true
	self._Dialog_Editor_BTN.button_pressed = false
	self._Story_Editor_BTN.emit_signal("pressed")


func _on_StoryFile_Editor_opened():
